...
This workspace contains the complete source code for the **Frakto Code Engine** — a powerful and extensible VS Code extension that connects your editor to an external formatting and linting script of your choice.

It is designed to give full control to developers by decoupling formatting and diagnostics from the extension logic. Frakto Code Engine simply delivers structured data (payloads) to your external tool and displays the results in the editor.

Everything is modular, clean, and ready to extend. No hidden logic. No opinionated behavior. You bring the rules — Frakto Code Engine just runs them.
